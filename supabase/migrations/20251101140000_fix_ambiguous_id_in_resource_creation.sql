-- Fix ambiguous column reference 'id' in create_resource_safe function
-- This migration ensures all column references are properly qualified with table aliases
...
BEGIN
  ...
  -- Return the created resource (with explicit table alias)
  RETURN QUERY
  SELECT 
    r.id,
    r.team_id,
