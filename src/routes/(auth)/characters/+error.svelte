<script lang="ts">
  ...
  import { Users, Home, RefreshCw } from 'lucide-svelte';
...
<svelte:head>
  <title>Characters Error - Cosplay Tracker</title>
</svelte:head>
  ...
  <Card class="w-full max-w-md">
    <CardHeader class="text-center">
      <div class="mx-auto mb-4 flex size-12 items-center justify-center rounded-full bg-destructive/10">
        <Users class="size-6 text-destructive" />
      </div>
      <CardTitle class="text-xl">Characters Error</CardTitle>
    </CardHeader>
    <CardContent class="space-y-4">
      <div class="text-center text-sm text-muted-foreground">
        <p class="mb-2">Unable to load character data.</p>
