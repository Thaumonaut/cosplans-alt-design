...
export const THEME_VARIANTS: ThemeVariant[] = [
	// === LIGHT THEMES ===
	{
		...
		cssVars: {
			...
			'--theme-section-bg': 'rgba(255, 255, 255, 0.9)',
			'--theme-card-bg': 'rgba(255, 255, 255, 0.6)',
			'--theme-card-nested': 'rgba(255, 255, 255, 0.9)',
			'--theme-content-bg': 'rgba(255, 255, 255, 0.9)',
			...
			'--theme-sidebar-hover': 'hsla(251, 91.30%, 95.50%, 0.60)',
			'--theme-sidebar-active': 'rgba(221, 214, 254, 0.7)',
			...
			'--theme-header-hover': 'rgba(237, 233, 254, 0.6)',
			'--theme-header-active': 'rgba(221, 214, 254, 0.7)',
			'--theme-header-shadow': '0 4px 24px 0 rgba(139, 92, 246, 0.12)',
			'--theme-hover': 'rgba(237, 233, 254, 0.6)',
			'--theme-active': 'rgba(221, 214, 254, 0.7)',
			'--theme-focus': '#ec4899',
			'--theme-interactive-hover': 'rgba(237, 233, 254, 0.6)',
			'--theme-interactive-active': 'rgba(221, 214, 254, 0.7)',
			...
			'--theme-info': '#3b82f6',
			'--theme-priority-low-bg': '#dbeafe',
			'--theme-priority-low-text': '#1e40af',
			'--theme-priority-low-border': '#93c5fd',
			'--theme-priority-low-dot': '#3b82f6',
			'--theme-priority-medium-bg': '#fef3c7',
			'--theme-priority-medium-text': '#92400e',
			'--theme-priority-medium-border': '#fbbf24',
			'--theme-priority-medium-dot': '#f59e0b',
			'--theme-priority-high-bg': '#fce7f3',
			'--theme-priority-high-text': '#9f1239',
			'--theme-priority-high-border': '#f472b6',
			'--theme-priority-high-dot': '#ef4444',
			'--theme-text-disabled': 'rgba(120, 113, 108, 0.5)',
			'--theme-border-focus': '#ec4899',
			'--theme-success-bg': '#d1fae5',
			'--theme-error-bg': '#fee2e2',
			'--theme-warning-bg': '#fef3c7',
			'--theme-info-bg': '#dbeafe',
			'--theme-overlay-bg': 'rgba(0, 0, 0, 0.5)',
			'--theme-modal-bg': 'rgba(255, 255, 255, 0.95)',
			...
			'--theme-section-opacity': '0.9',
			'--theme-card-opacity': '0.6',
			'--theme-overlay-opacity': '0.5',
			'--theme-blur-amount': '8px'
		},
		source: 'built-in'
	},
	{
		...
		cssVars: {
			...
			'--theme-hover': '#baffd3',
			'--theme-active': 'rgb(26 201 90)163 74)',
			'--theme-focus': '#22c55e',
			'--theme-primary': '#33F67B',
	...
	},
	{
		...
		cssVars: {
			...
			'--theme-hover': 'rgba(234, 88, 12, 0.1)',
			'--theme-active': 'rgba(234, 88, 12, 0.15)',
			'--theme-focus': '#f59e0b',
	...
	},
	{
		...
		cssVars: {
			...
			'--theme-hover': 'rgba(8, 145, 178, 0.1)',
			'--theme-active': 'rgba(8, 145, 178, 0.15)',
			'--theme-focus': '#06b6d4',
			'--theme-primary': '#0891b2',
			'--theme-primary-hover': '#0e7490',
			'--theme-accent': '#06b6d4',
			'--theme-accent-hover': '#0891b2',
			'--theme-text-disabled': 'rgba(71, 85, 105, 0.5)',
	...
	// === DARK THEMES (Hand-Crafted for Character & Charm) ===
	{
		...
		cssVars: {
			...
			'--theme-text-muted': 'rgba(168, 162, 158, 0.8)',
			'--theme-section-bg': 'rgba(24, 24, 27, 0.9)',
			'--theme-card-bg': 'rgba(39, 39, 42, 0.9)',
			'--theme-card-nested': 'rgba(24, 24, 27, 0.9)',
			'--theme-content-bg': 'rgba(39, 39, 42, 0.9)',
			'--theme-input-bg': 'rgba(24, 24, 27, 0.9)',
			'--theme-border': 'rgba(168, 162, 158, 0.2)',
			'--theme-border-subtle': 'rgba(168, 162, 158, 0.2)',
			'--theme-border-strong': 'rgba(168, 162, 158, 0.3)',
			'--theme-sidebar-bg': 'rgba(24, 24, 27, 0.9)',
			...
			'--theme-header-bg': 'rgba(39, 39, 42, 0.9)',
			...
			'--theme-active': 'rgba(255, 255, 255, 0.15)',
			'--theme-focus': '#22d3ee',
			...
			'--theme-warning': '#f59e0b',
			'--theme-info': '#3b82f6',
			'--theme-priority-low-bg': '#1e3a8a',
			'--theme-priority-low-text': '#93c5fd',
			'--theme-priority-low-border': '#3b82f6',
			'--theme-priority-low-dot': '#3b82f6',
			'--theme-priority-medium-bg': '#78350f',
			'--theme-priority-medium-text': '#fde68a',
			'--theme-priority-medium-border': '#f59e0b',
			'--theme-priority-medium-dot': '#f59e0b',
			'--theme-priority-high-bg': '#7f1d1d',
			'--theme-priority-high-text': '#f9a8d4',
			'--theme-priority-high-border': '#ec4899',
			'--theme-priority-high-dot': '#ef4444',
			'--theme-text-disabled': 'rgba(168, 162, 158, 0.5)',
			'--theme-border-focus': '#22d3ee',
			'--theme-success-bg': '#065f46',
			'--theme-error-bg': '#7f1d1d',
			'--theme-warning-bg': '#78350f',
			'--theme-info-bg': '#1e3a8a',
			'--theme-overlay-bg': 'rgba(0, 0, 0, 0.7)',
			'--theme-modal-bg': 'rgba(39, 39, 42, 0.95)',
	...
	},
	{
		...
		cssVars: {
			...
			'--theme-text-muted': 'rgba(189, 168, 122, 0.8)',
			...
			'--theme-priority-high-border': '#f472b6',
			'--theme-priority-high-dot': '#ef4444',
			'--theme-text-disabled': 'rgba(189, 168, 122, 0.5)',
			'--theme-border-focus': '#a3e635',
			'--theme-success-bg': '#065f46',
			'--theme-error-bg': '#7f1d1d',
			'--theme-warning-bg': '#78350f',
			'--theme-info-bg': '#1e3a8a',
			'--theme-overlay-bg': 'rgba(0, 0, 0, 0.7)',
			'--theme-modal-bg': 'rgba(53, 43, 32, 0.95)',
			'--theme-shadow-color': 'rgba(0, 0, 0, 0.5)',
			'--theme-shadow-sm': '0 1px 2px 0 rgba(0, 0, 0, 0.3)',
			'--theme-shadow-md': '0 4px 6px -1px rgba(0, 0, 0, 0.4)',
			'--theme-shadow-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.5)',
			'--theme-section-opacity': '1.0',
			'--theme-card-opacity': '1.0',
			'--theme-overlay-opacity': '0.7',
			'--theme-blur-amount': '8px'
		},
		source: 'built-in'
	},
	{
		...
		cssVars: {
			...
			'--theme-border-focus': '#f0abfc',
			'--theme-success-bg': '#065f46',
			'--theme-error-bg': '#7f1d1d',
			'--theme-warning-bg': '#78350f',
			'--theme-info-bg': '#1e3a8a',
			'--theme-overlay-bg': 'rgba(0, 0, 0, 0.7)',
			'--theme-modal-bg': 'rgba(30, 27, 75, 0.95)',
			'--theme-shadow-color': 'rgba(0, 0, 0, 0.5)',
			'--theme-shadow-sm': '0 1px 2px 0 rgba(0, 0, 0, 0.3)',
			'--theme-shadow-md': '0 4px 6px -1px rgba(0, 0, 0, 0.4)',
			'--theme-shadow-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.5)',
	...
	},
	{
		...
		cssVars: {
			...
			'--theme-text-muted': 'rgba(168, 162, 158, 0.7)',
			...
			'--theme-info-bg': '#1e3a8a',
			'--theme-overlay-bg': 'rgba(0, 0, 0, 0.7)',
			'--theme-modal-bg': 'rgba(28, 25, 23, 0.95)',
			'--theme-shadow-color': 'rgba(0, 0, 0, 0.5)',
			'--theme-shadow-sm': '0 1px 2px 0 rgba(0, 0, 0, 0.3)',
			'--theme-shadow-md': '0 4px 6px -1px rgba(0, 0, 0, 0.4)',
			'--theme-shadow-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.5)',
